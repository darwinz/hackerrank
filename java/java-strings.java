...
2. Determine if A is lexicographically larger than B (i.e.: does B come before
A in the dictionary?).
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String gt = (A.compareTo(B) > 0) ? "Yes" : "No";
        System.out.printf("%d%n%s%n%s %s%n", sum, gt, WordUtils.capitalize(A), WordUtils.capitalize(B));
    }
}
