...
# Lambdas can be used as arguments to higher-order functions. They can also be used to
# construct the result of a higher-order function that needs to return a function.
