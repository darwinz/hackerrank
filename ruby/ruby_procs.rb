...
# rule in Ruby. Blocks are not objects, and they can't be saved to variables.
...
# Procs are a great way of keeping your code DRY. DRY stands for Do not Repeat
# Yourself.
...
# The square_of_sum method computes the sum of the elements in an input array
# and returns the square of the summed elements.
...
proc_sum_array = proc { |a| a.inject(0) { |sum, x| sum + x } }
